...
const ClientFirstBookHero = () => {
  ...
  <div
    ...
    style={{
      background: 'linear-gradient(100.51deg, rgba(37, 25, 99, 0.8) 5.21%, rgba(106, 84, 213, 0.8) 95.67%)'
    }}
  >
        {/* Left Content */}
        <div className="flex flex-col items-start z-10 w-full xl:max-w-[650px] gap-[24px]">
          ...
          <div className="bg-[#D6CDFE] rounded-[54px] inline-flex w-fit h-auto items-center py-[8px] px-[16px] gap-[4px]">
            <span className="font-['Figtree',sans-serif] font-normal text-[13px] md:text-[14px] xl:text-[16px] text-[#6D6E72] leading-[140%] xl:leading-[170%] tracking-[-0.2px]">
              Führung in Professional Service Firms
            </span>
          </div>
          ...
          <h1 className="font-['Inter',sans-serif] font-bold text-[36px] md:text-[44px] xl:text-[56px] text-[#FFFFFF] leading-[110%] xl:leading-[100%] tracking-[-0.03em]">
            Weniger Management. <br /> Mehr Wirkung.
          </h1>

          {/* Paragraph */}
          <p className="font-['Inter',sans-serif] font-medium text-[16px] xl:text-[18px] text-[#F1EDED] leading-[140%] xl:leading-[120%] tracking-[0%]">
  &quot;Clients First&quot; zeigt, wie Sie altes Managementdenken hinter sich <br /> lassen – und mit Haltung, Orientierung und 7 praxiserprobten Hebeln echte Exzellenz im Unternehmen erwirken.
</p>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-[16px] w-full sm:w-auto mt-[6px]">
            <a 
              href="#free-chapter"
              className="h-[54.63px] w-full sm:w-[273.63px] bg-[#FFFFFF] rounded-[16px] flex items-center justify-center gap-[8px] group hover:bg-gray-100 transition-colors shrink-0"
            >
            ...
            <a 
              href="#buy-book"
              className="h-[55px] w-full sm:w-[149px] rounded-[16px] border border-[#FFFFFF] flex items-center justify-center hover:bg-white/10 transition-colors shrink-0"
            >
        ...
        <div className="hidden xl:block absolute right-[20px] top-1/2 -translate-y-1/2 z-10 pointer-events-none">
  <img
    src="/client-first-book-site/Frame.png"
    alt="Clients First Buch Cover"
    className="w-[620px] h-auto object-contain scale-[1.1]"
  />
</div>
...
export default ClientFirstBookHero
